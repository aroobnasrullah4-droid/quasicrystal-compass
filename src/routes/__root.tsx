...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ML-inspired tool for predicting quasicrystalline phase formation in Al-Cu-Fe-Mn alloys. PIEAS FYP research prototype." },
      { name: "author", content: "PIEAS MME" },
      { property: "og:title", content: "QC Phase Predictor — Al-Cu-Fe-Mn Quasicrystal Tool" },
      { property: "og:description", content: "ML-inspired tool for predicting quasicrystalline phase formation in Al-Cu-Fe-Mn alloys. PIEAS FYP research prototype." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "QC Phase Predictor — Al-Cu-Fe-Mn Quasicrystal Tool" },
      { name: "twitter:description", content: "ML-inspired tool for predicting quasicrystalline phase formation in Al-Cu-Fe-Mn alloys. PIEAS FYP research prototype." },
